...
export function SchedulingModal({
  ...
  const {
    ...
    confirmBooking,
    isDayDisabled,
  } = useScheduling(lead, open, initialDealId, initialDate, initialTime)
            ...
            <div>
              ...
              <p className="text-gray-500 mt-1">
                {lead
                  ...
                  : 'Selecione um cliente (Feature em breve)'}
              </p>
            </div>
          </div>
            ...
            <div className="flex-1 flex items-center justify-center p-10">
              <div className="text-center">
                ...
                <p className="text-gray-500 max-w-sm mx-auto">
                  Por enquanto, o agendamento deve ser iniciado através do card
                  do cliente no CRM ou lista de Clientes.
                </p>
                <AppButton
                  variant="outline"
                  className="mt-4"
