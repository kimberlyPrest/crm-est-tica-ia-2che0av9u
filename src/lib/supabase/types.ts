...
//
//       -- Logic:
//       -- 1. If org_name provided -> Create New Org (Sign Up Flow)
//       -- 2. If org_id provided -> Join Existing Org (Invite Flow)
//       -- 3. Else -> Fallback to Default (Should not happen in proper flow)
//
...
//           ('Novo', '#DDD6FE', 1, true, true, org_id),
//           ('Qualificado', '#BAE6FD', 2, false, false, org_id),
//           ('Agendado', '#FEF3C7', 3, false, false, org_id),
//           ('Cliente', '#D9F99D', 4, false, false, org_id),
//           ('Perdido', '#FCA5A5', 5, true, false, org_id),
//           ('Ser Humano', '#E5E7EB', 6, true, false, org_id);
//
//       ELSIF meta_org_id IS NOT NULL THEN
//           org_id := meta_org_id;
//       ELSE
//           -- Fallback for existing/legacy or errors
